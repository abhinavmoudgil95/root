...
////////////////////////////////////////////////////////////////////////////////
/// get the activation values of ith layer generated by DNN

std::vector<Float_t>& TMVA::MethodDNN::GetLayerActivationValues(const Event* ev, Int_t index)
{
   ...
   output = fNet.get_layer_activations(index, input, fWeights);    
   std::vector<Float_t> *fLayerActivations = new std::vector<Float_t>();
   Int_t numOfNodes = output.size();
   for (Int_t i = 0; i < numOfNodes; i++) {
      fLayerActivations->push_back(output.at(i));
   }
   return *fLayerActivations;
}
